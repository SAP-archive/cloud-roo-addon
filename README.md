...
[SAP NetWeaver Cloud](http://scn.sap.com/community/developer-center/cloud-platform) is a Java-based Platform-as-a-Service (PaaS) provided by [SAP AG](http://www.sap.com/). Currently SAP AG provides a [free 90-day-trial](http://scn.sap.com/docs/DOC-28197) of SAP NetWeaver Cloud, so it's easy to give it a try.
